...
phrs-create-osgibundle.bash - create a maven related directory structure for an 
                              OSGI bundle. 
                              This scripts requires the apache felix maven 
                              plugin  (see the http://felix.apache.org/site/apache-felix-maven-bundle-plugin-bnd.html fro more details)

phrs-create-plainjar.bash - create a maven related directory structure deployable 
                            like a plain jar file. 
phrs-create-webapp.bash - create a maven related directory structure deployable 
                          like a war file. 
