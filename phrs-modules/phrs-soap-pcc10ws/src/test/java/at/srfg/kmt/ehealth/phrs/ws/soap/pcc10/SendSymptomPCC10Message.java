 ...
 * a Symptom with the estabilish code Fever) request to a given end-point. <br/>
 * To run this class this class from
 * the command line and maven use the following command :
 * <pre>
 * mvn exec:java -Dexec.mainClass=at.srfg.kmt.ehealth.phrs.ws.soap.pcc10.SendSymptomPCC10Message -Dexec.classpathScope=test -Dexec.args="http://localhost:8989/testws/pcc10"
 ...
 * @since 1.0-SNAPSHOT
 */
public final class SendSymptomPCC10Message {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(SendSymptomPCC10Message.class);

    /**
     * Don't let anybody to instantiate this class.
     */
    private SendSymptomPCC10Message() {
        // UNIMPLEMENETD
    }
    ...
    /**
     * Builds a dummy PCC10 that contains a Symptom with the estabilish code
     * Fever.
     *
     * @return a dummy PCC10 that contains a Symptom with the estabilish code
     * Fever.
     */
