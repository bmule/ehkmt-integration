 ...
 * <pre>
 * mvn exec:java -Dexec.mainClass=at.srfg.kmt.ehealth.phrs.ws.soap.pcc10.DailyLivingStep10ClientExample -Dexec.classpathScope=test<br/>
 * </pre>
 ...
 * @since 0.1
 */
public class DailyLivingStep10ClientExample {
	...
	final String owner = Constants.PROTOCOL_ID_UNIT_TEST;
        ...
        QUPCAR004030UVUtil.toWriteInTemp(pCC10Message, "daily-living-step10");
