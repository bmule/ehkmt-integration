 ...
 * @since 1.0-SNAPSHOT
 */
public class PCC10SecureEndpoint {

    /**
     * The Logger instance. All log messages from this class are routed through
     * this member. The Logger name space is
     * <code>at.srfg.kmt.ehealth.phrs.ws.soap.PCC10SecureEndpoint</code>.
     */
    private static final Logger LOGGER =
            LoggerFactory.getLogger(PCC10SecureEndpoint.class);
     ...
     */
    public PCC10SecureEndpoint(String host, int port, String context,
     ...
     * malformated.
     */
    public void start() throws NoSuchAlgorithmException, KeyStoreException, IOException, CertificateException, UnrecoverableKeyException, KeyManagementException  {
        ...
        final ClassLoader classLoader = PCC10SecureEndpoint.class.getClassLoader();
        ...
        LOGGER.info("PCC10 Safe endpoint runs on {}", endpointURI);
