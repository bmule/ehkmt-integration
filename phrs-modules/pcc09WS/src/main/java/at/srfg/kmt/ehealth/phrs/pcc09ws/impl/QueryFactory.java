...
class QueryFactory {
    ...
    /**
     * Builds a <code>QUPCIN043100UV01</code> for the given list of parameters.
     *
     ...
     * <code>careProvisionCode</code> is not supported. You can prove if a
     * given careProvisionCode is supported by using the
     * <code>isCareProvisionCodeSupported</code> method.
     * @throws NullPointerException if the <code>patientID</code> is null.
     */
