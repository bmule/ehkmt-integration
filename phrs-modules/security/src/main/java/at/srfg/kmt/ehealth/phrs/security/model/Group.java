...
@Entity
@NamedQueries({
    @NamedQuery(name="findGroupForName", query="SELECT g FROM Group AS g e WHERE g.name = :name"),
    @NamedQuery(name="removeAllGroups", query="DELETE FROM Group g"),
    @NamedQuery(name="removeGroupForName", query="DELETE FROM Group g WHERE g.name = :name")
})
