 ...
 * @author Mihai
 */
public class ProblemEntryDynaBeanCientUnitTest {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(ProblemEntryDynaBeanCientUnitTest.class);
    private static final String USER = ProblemEntryDynaBeanCientUnitTest.class.getName();
    private GenericTriplestore triplestore;
    private DynaBeanClient dynaBeanClient;
    private ProblemEntryClient problemClient;

    public ProblemEntryDynaBeanCientUnitTest() {
    }
    ...
    @Test
    public void testAddProblemEntryForOwner() throws TripleException, IllegalAccessException, InstantiationException {
        ...
        for (String resoure : resources) {
            ...
            assertEquals(ProblemEntryClient.class.getName(), creator);
