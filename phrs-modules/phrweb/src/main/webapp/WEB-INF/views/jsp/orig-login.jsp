...
<!-- background-image: url(http://www.openid.net/login-bg.gif);
  ...
  <p>Please login with your <span style="color:orange">OpenID</span></p>
  ...
  <p><span style="color:green;font-size:1em">https://www.google.com/accounts/o8/id</span><span>For Google Test only </span></p>
  <p> paste the previous URL and replace the "id" with your Google email: <span style="color:green;font-size:1em">your_username@gmail.com</span></p>
