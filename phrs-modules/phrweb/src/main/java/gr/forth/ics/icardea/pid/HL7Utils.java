...
final public class HL7Utils {
	...
	public static void createHeader(Segment msh, String version)
		...
		msh.getField(3, 0).parse(PatientIndexConstants.app_name);
		msh.getField(4, 0).parse(PatientIndexConstants.fac_name);
	...
	public static void fillResponseHeader(Segment inbound, Segment outbound)
		 ...
		 */
		outbound.getField(3, 0).parse(PatientIndexConstants.app_name);
		outbound.getField(4, 0).parse(PatientIndexConstants.fac_name);
