...
public class PhrsConstants  implements Serializable {
	...
	public static final String OPEN_ID_PARAM_IDENTIFIER="url";
	...
	public static final String OPENID_ICARDEA_PROVIDER_KEY="openid_provider_icardea";
	...
	public final static String USER_HEALTH_PROFILE_PREFIX = "healthprofile";
	...
	public final static String USER_GUEST_HEALTH_PROFILE_ID = "/portal/"
			+ PORTAL_NAME_DEMO + "/" + USER_HEALTH_PROFILE_PREFIX + "/"
			+ USER_ID_GUEST;
