...
/**
 * Base class only for ProfileMedicalContactInfo
 */
@Entity
public class  BaseProfileContactInfo extends  BasePhrsModel {
	String contactType
	String personTitle
	/**
	 * Display name
 ...
 */   
	...
	public Map getEmail_obj(){
		Map<String,String> result= [
			...
			'href':BaseProfileContactInfo.makeHtml('email', 'email',email)]
	...
	public Map getInternetSystemFederatedId_obj(){
		Map<String,String> result= [
			...
			'href':BaseProfileContactInfo.makeHtml('internetFederatedId', internetFederatedIdProvider,internetFederatedId)]
	...
	public String getInternetChatId_obj(){
		...
		'id':internetChatId,
		'href': BaseProfileContactInfo.makeHtml('internetChatId', internetChatProvider,internetChatId)
		]
		return result
	}
	...
	public Map getInternetVoiceId_obj(){
		...
		'id':internetVoiceId,
		'href': BaseProfileContactInfo.makeHtml('internetVoiceId', internetVoiceProvider,internetVoiceId)
		]
		return result
	}
	...
	public Map getInternetPhone_obj(){
		Map<String,String> result=
			...
			'id':internetPhone,
			'phone':internetPhone,
			'href': BaseProfileContactInfo.makeHtml('internetPhone', '',internetPhone)
		]
		return result
	}
