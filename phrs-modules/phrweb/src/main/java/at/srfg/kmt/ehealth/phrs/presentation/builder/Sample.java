...
/*
 * Colume headers
 * is lookup code or label
 * List heading
 * use of String[]
 * Format object with headers, String[] for header and rows
 * 
 * header: how express I18 code vs label? in header
 * rows:  how express code for lookup in Vocab tool or I18? Already done by vocab tool?
 * Issue loose control over column widths unless addition string[] with col widths
 * 
 * 
 * ResourceTypes=ContactInfo, ContactInfoList
 * 
 * ContactInfo
 * ContactInfoList
 * 
