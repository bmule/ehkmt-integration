...
public class PhrPortalFactory implements Serializable {
    ...
    public CommonDao getCommonDao() {
        return PhrsStoreClient.getInstance().getPhrsRepositoryClient().getCommonDao();
    }

    public UserService getUserService() {
        return PhrsStoreClient.getInstance().getPhrsRepositoryClient().getUserService();
    }
    ...
    public InteropProcessor getInteropProcessor() {
        return PhrsStoreClient.getInstance().getInteropProcessor();
