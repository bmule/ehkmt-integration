...
@Entity("ActionPlanEvent")
public class ActionPlanEvent extends BasePhrsModel  {
	 ...
	 * @param form resource
	 */
	public ActionPlanEvent(BasePhrsModel base){
		super();
	...
	public ActionPlanEvent(Date beginDate, Date endDate, String headerColor, String contentColor, String content) {
		super();
	...
	public ActionPlanEvent(Date beginDate, Date endDate, String headerColor, String contentColor, String content, String title) {
	...
	public ActionPlanEvent(Date beginDate, Date endDate, String headerColor, String contentColor, String content, String title, boolean locked) {
