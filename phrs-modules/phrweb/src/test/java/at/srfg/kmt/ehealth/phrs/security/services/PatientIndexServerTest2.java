...
public class PatientIndexServerTest2 {
   
	static Logger logger = Logger.getLogger(PatientIndexServerTest2.class);
	...
	public void run(String[] args) throws Exception {
		...
		PatientIndexServerTest2.app_name = cfg.getKeyValue("server", "application_name", app_name);
		PatientIndexServerTest2.fac_name = cfg.getKeyValue("server", "facility_name", fac_name);
	...
	public static void main(String[] args) throws Exception {
		PatientIndexServerTest2 pid = new PatientIndexServerTest2();
		pid.run(args);
	}*/
}