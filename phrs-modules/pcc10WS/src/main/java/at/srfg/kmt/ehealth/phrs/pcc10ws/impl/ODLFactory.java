...
/**
 * Used to build Observation of Daily Living according with the HL7 v3. <br>
 ...
 * @author Mihai
 */
final  class ODLFactory implements PCC10Factory<QUPCIN043200UV01> {

    /**
     * The Logger instance. All log messages from this class
     * are routed through this member. The Logger name space
     * is <code>at.srfg.kmt.ehealth.phrs.ODLFactory</code>.
     */
    private static final Logger LOGGER =
            LoggerFactory.getLogger(ODLFactory.class);
