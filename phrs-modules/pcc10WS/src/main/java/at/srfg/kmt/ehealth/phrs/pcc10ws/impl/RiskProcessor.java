 ...
 * @author Mihai
 */
final class RiskProcessor implements Processor<Response> {

    /**
     * The Logger instance. All log messages from this class
     * are routed through this member. The Logger name space
     * is <code>at.srfg.kmt.ehealth.phrs.security.impl.RiskProcessor</code>.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(RiskProcessor.class);

    private static final PCC10Factory<QUPCIN043200UV01> RISK_FACTORY =
            new RiskFactroy();
    ...
    /**
     * Builds a <code>RiskProcessor</code> instance.
     */
    RiskProcessor() {
    ...
    public boolean process(Object input) {
        ...
        try {
            QUPCAR004030UVServiceUtil.toWriteInTemp(vitalSigns, "risks");
        } catch (Exception exception) {
            // I dont care !
        }
    ...
    private QUPCIN043200UV01 buildProblems() throws
        ...
        ((RiskFactroy) RISK_FACTORY).setRisks(allRisks);

        final QUPCIN043200UV01 build = RISK_FACTORY.build();
        return build;
    }
}
