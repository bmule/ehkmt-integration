...
import at.srfg.kmt.ehealth.phrs.ws.soap.pcc9.PCC9Endpoint;
 ...
 * @since 1.0-SNAPSHOT
 */
public final class PCC9EndpointExample {

    /**
     * Don't let anybody to instantiate this class.
     */
    private PCC9EndpointExample() {
        // UNIMPLEMEENTD
    }
...
//        final PCC9Endpoint endpoint = new PCC9Endpoint("localhost", 8989, "testws/pcc9");
        final PCC9Endpoint endpoint = new PCC9Endpoint(host, Integer.parseInt(port), path);
        endpoint.start();
    }
}
