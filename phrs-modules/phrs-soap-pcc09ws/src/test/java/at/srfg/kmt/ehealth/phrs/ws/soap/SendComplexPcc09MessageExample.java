 ...
 * <pre>
 * mvn exec:java -Dexec.mainClass=at.srfg.kmt.ehealth.phrs.ws.soap.SendComplexPcc09MessageExample -Dexec.classpathScope=test -Dexec.args="http://localhost:8080/testws"
 * </pre> <b>Note : </b> the end-point where the PCC9 request will send is
 * specified with the "-Dexec.args=" statement. <br/> This class is not design
 * to be extended.
 *
 * @author mihai
